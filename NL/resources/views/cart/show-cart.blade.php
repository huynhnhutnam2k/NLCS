                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ URL::to('/update-cart-qty') }}" method="post"
                                ...
                                {{ csrf_field() }}
                                <input type="number" value="{{ $cart->qty }}" width="50%" name="qty" min="1"
                                    max="20" style="width:50px;height:35px">
                                <input type="hidden" value="{{ $cart->rowId }}" name="rowId_cart"
                                    class="qty">
                                <input type="submit" value="Cập nhật" name="number-qty" class="btn"
                                    style="float: right;width:150px;height:35px">
                            </form>
                        </td>
                        <td style="color:red;">
                            <?php

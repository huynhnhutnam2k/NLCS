...
accordionHeader.forEach(item => item.addEventListener('click', function () {
    console.log('dsnajfndo')
}));
...
accordionHeaderCart.forEach(item => item.addEventListener('click',handleClickAccordionCart))

...
<body>
    <header class="header">
            ...
            <div class="header-top-right">
                <ul class="header-top-list">
                    ...
                    <?php 
                                ...
                                if ($user_id ==NULL) {
                                 ?>
                    <li><a href="{{ URL::to('login-checkout') }}" class="header-top-item">ĐĂNG NHÂPJ</a></li>
                    </li>
                    <?php }else{ ?>
                    <li><a href="{{ URL::to('logout-checkout') }}" class="header-top-item">Hi
                            <?= Session::get('name_user') ?>, Đăng xuất</a></li>
                    </li>
                    <?php } ?>
                </ul>
            </div>
        ...
        <div class="header-main">
            <a href="{{ URL::to('/') }}" class="header-logo">B Watch</a>
            ...
            <div class="header-hotline">Hotline: 035 799 7799</div>
        </div>
    ...
    <footer class="footer">
        <div class="footer-logo">
            <h2>BWatch</h2>
            <hr>
            <p>Hotline: 035 799 7799</p>
        </div>
        <div class="footer-pay">
            <h2>Liên hệ và thanh toán</h2>
            <hr>
            <p>Hotline: 035 799 7799</p>
            <a href="#">Website: BWatch.vn</a>

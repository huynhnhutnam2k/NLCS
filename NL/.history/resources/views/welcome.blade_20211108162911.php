...
@section('content')
    <main>
        <section class="hero" style="height: 500px">
            <img src="{{{'https://images.unsplash.com/photo-1523527692532-b7811d223c53?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=774&q=80'}}}" style="width: 100%" alt="">
        </section> 

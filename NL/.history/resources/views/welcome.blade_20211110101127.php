...
@section('content')
    <main>
        <section class="hero">
            <img src="{{{'https://scontent.fsgn2-5.fna.fbcdn.net/v/t1.15752-9/254738160_491850595535700_211938108314932272_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=ae9488&_nc_ohc=i_d3tnJLNokAX8ILR_N&_nc_ht=scontent.fsgn2-5.fna&oh=702e6c21c0ec39712863c2b10eb8e162&oe=61B012ED'}}}" alt="">
        </section> 

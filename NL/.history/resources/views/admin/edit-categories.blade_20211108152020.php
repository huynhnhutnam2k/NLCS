                        ...
                        @foreach ($edit_cate as $cate)
                            <form role="form" action="{{ URL::to('/update-categories=' . $cate->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tên nhãn hiệu" name="name_cate"
                                        value="{{ $cate->cate_name }}">
                                </div>

                                <div class="form-group">
                                    <label>Tên người thêm</label>
                                    <input type="text" class="form-control" value="{{ $cate->cate_name_author }}"
                                        name="name_author">
                                </div>
                                <div class="form-group">
                                    <label>ID </label>
                                    <input type="text" class="form-control" value="{{ $cate->cate_author_id }}"
                                        name="id_author">
                                </div>
                                {{-- <div class="form-group">
                                    <label><img src="{{$cate->cate_images}}" width="150px;"></label>
                                    <br>
                                    <input type="file" >
